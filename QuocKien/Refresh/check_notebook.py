...
CHUNK_SIZE = 20000   # 20k users per chunk to balance memory and speed
...
def build_lgb_dataset_streaming(target_tx, tables, final_features, sample_n, flags):
    ...
    print("")
    return lgb.Dataset(np.vstack(all_X), label=np.concatenate(all_y), group=np.concatenate(all_groups))
...
# ==============================================================
FINAL_FEATURES = [
    'svd_score', 'final_score', 'rank_A_history', 'rank_B_local', 'rank_C_svd', 
    'rank_D_i2i', 'rank_E_cat', 'rank_F_brand', 'rank_G_global', 'rank_H_trend',
    'u_total_tx', 'u_total_qty', 'u_total_spend', 'u_unique_items', 'u_tenure_days',
    'u_recency_days', 'u_loc_hhi', 'u_cat_hhi', 'u_brand_hhi', 'u_avg_basket_size',
    'u_avg_order_value', 'u_tx_velocity', 'i_sales_all', 'i_sales_30d', 
    'i_sales_60_to_30d', 'i_sales_90_to_60d', 'cat_sales_30d', 'cat_sales_60d', 
    'cat_momentum', 'item_repeat_propensity', 'item_launch_age_days', 
    'i_momentum_30d', 'i_momentum_60d', 'ui_purchase_count', 'ui_total_qty', 
    'ui_days_since_last', 'ui_days_since_first', 'ui_avg_qty_per_order', 
    'ui_purchase_velocity', 'ui_replenishment_due', 'ui_age_delta', 'ui_recency_weight',
    'u_cat_purchases', 'u_cat_share_of_wallet', 'u_brand_purchases', 'u_brand_share_of_wallet',
    'u_child_age_estimate', 'cross_cat_momentum', 'cross_brand_momentum', 'cross_price_ratio', 
    'ui_habitual_match'
]
...
ev_hist_dec = scan_events(cutoff_end=datetime(2025, 12, 1))
tx_full_dec = scan_tx_full(cutoff_end=datetime(2025, 12, 1))
...
final_lgb_train = build_lgb_dataset_streaming(targ_dec, tables_dec, FINAL_FEATURES, sample_n=80000, flags=flags)
...
del hist_inf, ev_hist_inf, tx_full_inf, tables_dec; gc.collect()
