...
print("Generating shifted 10, 11, 12 folds (f1=fold 10, f2=fold 11, f3=fold 12)...")
f1 = check_fold_details(9, 10)
f3 = check_fold_details(11, 12)

print("\n--- f3 (December Validation) Target Stats ---")
...
print("\nTraining LightGBM on December Fold...")
param = {
...
print(f"\n--- [LGBM DECEMBER SHIFTED RUN SCORE]: {score} ---")
