...
cell_5_source = """print("Executing Chunked OOM-Safe Submission Generation (Streaming to pkl)...")
...
def make_chunked_submission_pkl(history_df, items_df, target_users, model, all_feats, output_path, chunk_size=20000):
    # Enable global string cache to guarantee categorical join alignment
    ...
    # --- DOWNCAST AND OPTIMIZE TYPES FOR 32-BIT TO SAVE 50% RAM AND COMPLETELY ELIMINATE SWAP BOTTLE-NECK ---
...
print("Notebook successfully updated with type-safe downcasting and categorical caches!")
